...
export default function GiftCardPage() {
  ...
  const giftCardDesigns = [
    ...
    { id: 1, name: "Morning Brew", image: "/images/gift-cards/2.png", color: "bg-[#A67C52]" },
    { id: 2, name: "Coffee Beans", image: "/images/gift-cards/3.png", color: "bg-[#5A4020]" },
    { id: 3, name: "Premium Gold", image: "/images/gift-cards/4.png", color: "bg-[#E3A95C]" },
  ];
