        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-text-secondary">
              Serving high-quality coffee and creating memorable experiences since 2020.
            </p>
            <div className="flex gap-4 mt-6">
              <a href="https://www.instagram.com/artcoffee_05/?igsh=emJvYjh2MHphOTZ0#" aria-label="Instagram" className="text-text-secondary hover:text-primary transition-colors">
              ...
              <a href="https://www.facebook.com/artkafeelbasan/" aria-label="Facebook" className="text-text-secondary hover:text-primary transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
